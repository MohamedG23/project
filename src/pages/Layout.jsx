          ...
          <AnimatePresence>
            {isOpen && (
              <>
                ...
                >
                  <button onClick={() => setIsOpen(false)} className="mb-8 text-red-500" > Close ✕ </button>

                  <nav className="flex flex-col gap-4">
                    <a href="/" className="text-lg hover:text-blue-600">
                      Home
                    </a>
                    <a href="/shop" className="text-lg hover:text-blue-600">
                      Shop
                    </a>
                    <a href="/about" className="text-lg hover:text-blue-600">
                      About Us
                    </a>
                    <a href="/blog" className="text-lg hover:text-blue-600">
                      Blog
                    </a>
        ...
        <div className="hidden md:flex gap-25 text-scolor justify-between">
          <div className="flex gap-6">
            <NavLink
              to="/"
              className={({ isActive }) =>
                `hover:text-white hover:border-b-3 hover:border-b-amber-500 transition-colors ${isActive ? "active-link text-white border-b-3 border-b-amber-500" : ""}`
              }
            >
              Home
            </NavLink>
